				...
				while($display_question=mysqli_fetch_assoc($Display)){
					...
					echo "
							<div class='container'>
								<div class='row'>
									<div class='col-md-8'>
										<h5><a id='anchor' target='_blank' href='discussion_reply.php?id=".$display_question['Q_id']."'>".$display_question['Comment']."</a></h5>"."<span onclick='likes(".$Question_id.")' ><label class='fa fa-thumbs-o-up'></span> <span id='".$Question_id."'>
										".mysqli_num_rows($Likes)."</span>
									"."
									</div>
									<div class='col-3'>	
